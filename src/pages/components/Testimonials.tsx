      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-0 mt-0 px-6 md:px-0 ">
        ...
        <div className="flex flex-col rounded-3xl transform transition duration-500 ">
          <div className="md:px-24 py-16 flex flex-col pt-10">
            ...
            <br />
            <br />
            <p className="text-black text-center mt-2 m-auto">Our aim is to sanitize the meat and poultry value chain in Africa using mechanised and semi-mechanised farming abattoirs via our proteintrail technology, guaranteeing traceability and thereby increasing corporate investments in mechanised and semi-mechanised slaughterhouses on the continent.
              <br />
              <br />
